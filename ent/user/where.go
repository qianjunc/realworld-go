...
// HasFavorite applies the HasEdge predicate on the "favorite" edge.
func HasFavorite() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(FavoriteTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, FavoriteTable, FavoritePrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasFavoriteWith applies the HasEdge predicate on the "favorite" edge with a given conditions (other predicates).
func HasFavoriteWith(preds ...predicate.Article) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(FavoriteInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, FavoriteTable, FavoritePrimaryKey...),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
// HasMyComments applies the HasEdge predicate on the "myComments" edge.
func HasMyComments() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(MyCommentsTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, MyCommentsTable, MyCommentsColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasMyCommentsWith applies the HasEdge predicate on the "myComments" edge with a given conditions (other predicates).
func HasMyCommentsWith(preds ...predicate.Comment) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(MyCommentsInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, MyCommentsTable, MyCommentsColumn),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
